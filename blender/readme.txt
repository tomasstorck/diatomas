...
Other files (e.g., rendermonitor.py, ecolidriver.py) can be run in pure python and will call Blender when needed.  It is generally not needed to manuallly call blender --python
