...
% 		--> now done with other programme
% 		fprintf(fid,['text {\n',...
% 			sprintf('\tttf "timrom.ttf" "Movement time: %05.2f s" 0.05, 0.1*x\n',model.movementIter*model.movementTimeStepEnd+ii*model.movementTimeStep),...
...
% 			'}\n',...
% 			'text {\n',...
% 			sprintf('\tttf "timrom.ttf" "Growth time:     %05.1f h" 0.05, 0.1*x\n',model.growthIter*model.growthTimeStep/3600.0),...		% divided by 3600 to go from [s] --> [h]
% 			'\tpigment {color rgb <0.000, 0.000, 0.000>  }\n',...
% 			sprintf('\tscale <%f,%f,%f>\n', textscale, textscale, textscale),...
