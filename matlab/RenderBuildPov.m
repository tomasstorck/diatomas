...
for iAnchor = 1:length(model.anchorSpringArray)
	...
	if round(round(ball.pos*1e6/1000)*1000)==0	% If equal until 3 decimals, scaled to micron, skip this one because it will produce "degenerate cylinders"
		fprintf(fid,['cylinder\n',...
			'{\n',...
			position,...
			sprintf('\t<%10.6f,%10.6f,%10.6f>,\n', ball.pos(1)*1e6, 0.0, ball.pos(3)*1e6),...
