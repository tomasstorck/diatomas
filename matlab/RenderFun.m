...
... 				'\t\t\tcolor_map{\n',...
... 				sprintf('\t\t\t\t[0.4 color rgb< %10.6f,%10.6f,%10.6f >]', cell.colour(1), cell.colour(2), cell.colour(3)),...
... 				'\t\t\t\t[0.4 color rgb< 1,1,1 >]\n',...
... 				'\t\t\t\t[0.6 color rgb< 1,1,1 >]\n',...
... 				sprintf('\t\t\t\t[0.6 color rgb< %10.6f,%10.6f,%10.6f >]', cell.colour(1), cell.colour(2), cell.colour(3)),...
... 				'\t\t\t}\n',...
... 				'\t\t\tfrequency 6',...
