...
public class Run {
	...
	public void Initialise() throws RuntimeException{				
		...
		case 0:
			...
			model.radiusCellStDev[4] = 0.05*model.radiusCellMax[4];// [m] Standard deviation from radiusCellMax. Note that this will work only with fixed radius rods! Spheres and var. radius rods must have a "free" radius
			model.NCellInit = 1;
